...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('admin.service.index') }}">
            ...
            <div class="page-header mb-4">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col">
                            <h1 class="h2 mb-0">Tambah Layanan Baru</h1>
                        ...
                        <div class="col-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 bg-transparent p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.service.index') }}" class="text-white">Kelola Layanan</a></li>
                                    <li class="breadcrumb-item active text-white-50" aria-current="page">Tambah Layanan Baru</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
