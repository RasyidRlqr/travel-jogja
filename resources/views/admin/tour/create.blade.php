...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('admin.tour.index') }}">
                    <i class="bi bi-map"></i>
            ...
            <div class="page-header mb-4">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col">
                            <h1 class="h2 mb-0">Tambah Paket Wisata</h1>
                        ...
                        <div class="col-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 bg-transparent p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.tour.index') }}" class="text-white">Kelola Paket Wisata</a></li>
                                    <li class="breadcrumb-item active text-white-50" aria-current="page">Tambah Paket Wisata</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-lg-10">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white">
                            <h5 class="card-title mb-0">Form Tambah Paket Wisata</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.tour.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div id="upload_section">
                                                ...
                                                @error('image')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <div class="form-text">Format: JPG, PNG, GIF. Maksimal 2MB. Rasio gambar yang disarankan: 4:3</div>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('itinerary') is-invalid @enderror" id="itinerary" name="itinerary" rows="8" placeholder="Deskripsikan itinerary perjalanan...">{{ old('itinerary') }}</textarea>
                                            @error('itinerary')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('includes') is-invalid @enderror" id="includes" name="includes" rows="4" placeholder="Transportasi, penginapan, makan, dll...">{{ old('includes') }}</textarea>
                                            @error('includes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('excludes') is-invalid @enderror" id="excludes" name="excludes" rows="3" placeholder="Biaya pribadi, tiket pesawat, dll...">{{ old('excludes') }}</textarea>
                                            @error('excludes')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-check-circle me-2"></i>Simpan Paket Wisata
                                    </button>
